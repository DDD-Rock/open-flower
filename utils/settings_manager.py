...
class SettingsManager:
    ...
    def save_settings(self, 
                      ...
                      lounge_move_min_minutes: int = 15,
                      lounge_move_max_minutes: int = 30,
                      character_name: str = "",
        ...
        self.config["General"] = {
            ...
            "lounge_move_min_minutes": str(lounge_move_min_minutes),
            "lounge_move_max_minutes": str(lounge_move_max_minutes),
    ...
    def load_settings(self) -> Optional[dict]:
        ...
        try:
            ...
            settings = {
                ...
                "lounge_move_min_minutes": self.config.getint("General", "lounge_move_min_minutes", fallback=15),
                "lounge_move_max_minutes": self.config.getint("General", "lounge_move_max_minutes", fallback=30),
